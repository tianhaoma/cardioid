...
#include "BetterTT06_gNa_gCaL_malignantVA.hh"
...
static const char* interpName[] = {
   ...
   REACTION_FACTORY(BetterTT06_gNa_gCaL_malignantVA)(OBJECT* obj, const double _dt, const int numPoints, const ThreadTeam&)
   {
      BetterTT06_gNa_gCaL_malignantVA::ThisReaction* reaction = new BetterTT06_gNa_gCaL_malignantVA::ThisReaction(numPoints, _dt);
      ...
      double g_pK;
      double g_to;
      setDefault(celltype, 2);
      //setDefault(g_CaL, 3.98000000000000e-5);//origin
      //setDefault(g_CaL, 3.98e-6);
...
namespace BetterTT06_gNa_gCaL_malignantVA 
{
...
{
   return "BetterTT06_gNa_gCaL_malignantVA";
}
