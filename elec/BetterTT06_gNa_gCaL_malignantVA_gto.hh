...
REACTION_FACTORY(BetterTT06_gNa_gCaL_malignantVA_gto)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);    
...
namespace BetterTT06_gNa_gCaL_malignantVA_gto
{
   ...
   class ThisReaction : public Reaction
   {
    ...
    public:
      ...
      FRIEND_FACTORY(BetterTT06_gNa_gCaL_malignantVA_gto)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);
   };
}
