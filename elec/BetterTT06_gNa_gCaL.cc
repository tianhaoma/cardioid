...
#include "BetterTT06_gNa_gCaL.hh"
...
static const char* interpName[] = {
   ...
   REACTION_FACTORY(BetterTT06_gNa_gCaL)(OBJECT* obj, const double _dt, const int numPoints, const ThreadTeam&)
   {
      BetterTT06_gNa_gCaL::ThisReaction* reaction = new BetterTT06_gNa_gCaL::ThisReaction(numPoints, _dt);
