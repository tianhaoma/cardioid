...
REACTION_FACTORY(BetterTT06_gNa)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);    
...
namespace BetterTT06_gNa
{
   ...
   class ThisReaction : public Reaction
   {
    ...
    public:
      ...
      FRIEND_FACTORY(BetterTT06_gNa)(OBJECT* obj, const double dt, const int numPoints, const ThreadTeam& group);
   };
}
